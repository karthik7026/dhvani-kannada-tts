...
`colab_f5_tts.ipynb` is the setup for Google Colab GPU training. In
...
reviewed `metadata.csv` and `wavs/` directory. Save any checkpoints to private Drive before the
runtime ends.
